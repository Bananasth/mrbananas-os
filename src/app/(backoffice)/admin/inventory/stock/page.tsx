...
export const metadata: Metadata = { title: 'Stock on hand · Setup' }
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border text-left text-xs text-muted">
                <th className="py-2 pr-3 font-medium">วัตถุดิบ · Item</th>
                <th className="py-2 pr-3 font-medium">ชนิด · Kind</th>
                ...
                return (
                  <tr key={s.item_id} className="border-b border-border/60">
                    ...
                    <td className="py-2 pr-3">
                      {it ? <Badge variant="neutral">{it.item_kind}</Badge> : '—'}
                    </td>
